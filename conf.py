...
# Param
parser.add_argument('-p', '--dataset_path', default='../../../../Data/ABAW4', help='Path to dataset')
parser.add_argument('-c', '--num_classes', type=int, default=12, help='Number of classes')
parser.add_argument('-n', '--neighbor_num', type=int, default=4, help='Neighbor number')
parser.add_argument('-i', '--img_size', type=int, default=224, help='Image size')
